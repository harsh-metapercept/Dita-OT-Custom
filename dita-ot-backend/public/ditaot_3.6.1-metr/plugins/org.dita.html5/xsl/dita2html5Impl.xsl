...
--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
  ...
  <xsl:import xmlns:dita="http://dita-ot.sourceforge.net" href="plugin:com.metr.ditasearch:xsl/header-footer.xsl"/><xsl:import href="plugin:fox.jason.extend.css:xsl/xhtml.xsl"/>
