...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--contents
  of table entries or similer structures-->
  ...
  <xsl:attribute-set name="__tableframe__top" use-attribute-sets="common.border__top">
    ...
    <xsl:attribute name="border-before-color">#E1E2E8</xsl:attribute>
    <xsl:attribute name="border-after-color">#E1E2E8</xsl:attribute>
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="thead__tableframe__bottom" use-attribute-sets="common.border__bottom">
    ...
    <xsl:attribute name="border-start-color">#E1E2E8</xsl:attribute>

    <xsl:attribute name="border-end-style">solid</xsl:attribute>
    <xsl:attribute name="border-end-width">1px</xsl:attribute>
    <xsl:attribute name="border-end-color">#E1E2E8</xsl:attribute>
  ...
  <xsl:attribute-set name="table.tgroup">
    ...
    <!--xsl:attribute
    name=&quot;inline-progression-dimension&quot;&gt;auto&lt;/xsl:attribute-->
  ...
  <xsl:attribute-set name="table__tableframe__sides"
    use-attribute-sets="table__tableframe__right table__tableframe__left">
    <!--<xsl:attribute
    name="border-after-style">solid</xsl:attribute>
    <xsl:attribute name="border-after-width">1px</xsl:attribute>
    <xsl:attribute name="border-after-color">#E1E2E8</xsl:attribute>-->
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="dl.dlfoot">
  </xsl:attribute-set>

  <xsl:attribute-set name="dl.dlentry">
    <xsl:attribute name="space-before">3pt</xsl:attribute>
    <xsl:attribute name="space-after">3pt</xsl:attribute>
    <xsl:attribute name="font-size">12pt</xsl:attribute>
  </xsl:attribute-set>

  <xsl:attribute-set name="dl.dlentry__content" use-attribute-sets="common.table.body.entry">
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="list.item__content">
    <xsl:attribute name="line-height">1.2</xsl:attribute>
    <xsl:attribute name="font-size">10pt</xsl:attribute>
  </xsl:attribute-set>
