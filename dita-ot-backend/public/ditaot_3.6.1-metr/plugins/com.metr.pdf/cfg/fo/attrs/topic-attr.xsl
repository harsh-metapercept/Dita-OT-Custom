...
<!--        <xsl:attribute name="space-before.optimum">160pt</xsl:attribute>
        <xsl:attribute name="space-after.optimum">160pt</xsl:attribute>
-->        <xsl:attribute name="line-height">18pt</xsl:attribute>
    </xsl:attribute-set>
    
    <xsl:attribute-set name="p_child">
    ...
    <xsl:attribute-set name="liitemgrouppara">
...
<!--        <xsl:attribute name="white-space-treatment">ignore-if-after-linefeed</xsl:attribute>-->
    ...
    <xsl:attribute-set name="image">
        <!--<xsl:attribute name="baseline-shift">middle</xsl:attribute>
    ...
    <xsl:attribute-set name="overview">
        <xsl:attribute name="font-weight">bold</xsl:attribute>
        <xsl:attribute name="color">#015F74</xsl:attribute>
