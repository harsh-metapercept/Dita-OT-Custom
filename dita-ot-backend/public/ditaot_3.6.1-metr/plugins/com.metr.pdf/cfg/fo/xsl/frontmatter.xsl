...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="createFrontCoverContents">
    <!-- set the title -->
    <fo:block xsl:use-attribute-sets="__frontmatter__title_logo">
      <fo:external-graphic>
        <xsl:attribute name='src'>
          <xsl:attribute name="background-image">url(Customization/OpenTopic/common/artwork/pdf_logo/CoverLogo.png)</xsl:attribute>
        </xsl:attribute>
      </fo:external-graphic>
    </fo:block>
