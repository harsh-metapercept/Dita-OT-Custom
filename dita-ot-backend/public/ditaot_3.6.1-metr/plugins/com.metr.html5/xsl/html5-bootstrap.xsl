...
>
  ...
  <xsl:param name="BOOTSTRAP_DARK_MODE_TOGGLER_INCLUDE" select="'no'"/>
  <!-- Whether to include dark mode toggling.  values are 'yes' or 'no' -->
  <xsl:param name="BOOTSTRAP_POPOVERS_INCLUDE" select="'none]'"/>
<!-- Whether to include a scrollspy Toc -->
  ...
  <xsl:include href="../Customization/xsl/footer.xsl"/>
  <xsl:include href="../Customization/xsl/headerNew.xsl"/>
  ...
  <xsl:template match="*" mode="chapterHead">
    <head>
      ...
      <!-- <link id="favicon" rel="icon" type="image/png" href="favicon.png"></link> -->
      <link rel="icon" type="image/png" href="{$relpath}/images/Web_favicon.png"></link>
  ...
  <xsl:template match="*" mode="chapterBody">
    ...
    <div class="container-fluid">
      <div class="bs-container bd-gutter mt-3 my-md-4" id="content">
  ...
  <footer class="ignore-this no-print sticky-lg-bottom">
    <div class="container">
      ...
      <!-- Footer  -->
      <!-- <xsl:call-template name="my-footer"/> -->
      ...
      <script language="javascript" src="/js/dark-mode-toggler.js"/>
      <script language="javascript" src="/js/popovers.js"/> -->
      <!-- ↑ End customization -->
